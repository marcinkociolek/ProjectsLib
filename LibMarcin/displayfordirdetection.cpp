...
//-----------------------------------------------------------------------------------------------
void ShowDirection(Mat ImToShow, int y, int x, float direction, int lineWidth, int lineLength, double scale, cv::Scalar color)
{
    ...
    line(ImToShow, Point(x - lineOffsetX, y - lineOffsetY), Point(x + lineOffsetX, y + lineOffsetY), color, lineWidth);
    Mat ImToShowTemp;
    if (scale !=1.0)
...
//-----------------------------------------------------------------------------------------------
void ShowDirectionGray(Mat ImToShow, int y, int x, float direction, int lineWidth, int lineLength, double scale, cv::Scalar color)
{
    int lineOffsetX = (int)round(lineLength * 0.5 *  sin((double)direction* PI / 180.0));
    int lineOffsetY = (int)round(lineLength * 0.5 * cos((double)direction* PI / 180.0));
